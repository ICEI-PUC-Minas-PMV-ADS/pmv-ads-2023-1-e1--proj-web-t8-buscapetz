...
fetch('../../../data/petz.txt')
  ...
  .then(text => {
    ...
    newHtml += '            <div class="row mb-5 mt-0">';
      ...
      newHtml += '                  <div class="row p-0">';
      newHtml += '                      <div class="w-100 text-center">';
      newHtml += '                          <h2>' + eachPetlistItem.nomePet + '</h2>';
      newHtml += '                      </div>';
      newHtml += '                  </div>';
      newHtml += '                  <div class="row py-4">';
      newHtml += '                      <div class="col-sm-10 mx-auto">';
      newHtml += '                      <!-- Tag / Características -->';
      newHtml += '                          <!-- <ul class="list-group list-group-flush"> -->';
      newHtml += '                              <button type="button" class="btn ' + (usuarioPetz[0].especie == eachPetlistItem.especie ? "btn-info" : "btn-secondary") + ' mx-1 my-1">' + eachPetlistItem.especie + '</button>';
      ...
      newHtml += '                              <button type="button" class="btn  ' + (usuarioPetz[0].docil == eachPetlistItem.docil ? "btn-info" : "btn-secondary") + ' mx-1 my-1">' + eachPetlistItem.docil + '</button>';
      newHtml += '                              <button type="button" class="btn  ' + (usuarioPetz[0].genero == eachPetlistItem.genero ? "btn-info" : "btn-secondary") + ' mx-1 my-1">' + eachPetlistItem.genero + '</button>';
      newHtml += '                          <!-- </ul> -->';
      newHtml += '                      </div>';
      newHtml += '                  </div>';
      newHtml += '              </div>';
